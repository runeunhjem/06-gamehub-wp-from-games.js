...
function createDetails() {
  ...
  console.log("games on line 18 with games.js is: ", games);
  console.log("games.length on line 18 with games.js is: ", games.length);
  console.log("games[0] on line 18 with games.js is: ", games[0].itemName);
  console.log("game.id's line 19 in games array:", games.map((game) => parseInt(game.id)));
