...
// ADD TO WISHLIST FUNCTION
  ...
  if (gamesContainer) {
    ...
    const wishlistIcon = document.querySelector(".add-to-wishlist .wishlist-icon");

    wishlistIcon.addEventListener("click", function () {
      const heartIconUrl = this.classList.contains("far") ? "images/ico_heart.svg" : "images/ico_heart_+.svg";
      this.src = heartIconUrl;
