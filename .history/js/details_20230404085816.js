...
fetch(apiUrl)
  ...
  .then((data) => {
    ...
    function createDetails() {
      ...
      const price = parseInt(game.currentPrice);
      ...
      function addToCart() {
        ...
        const currentPrice = parseInt(game.currentPrice);
        const beforePrice = parseInt(game.beforePrice);
  ...
  //     console.log("parseInt(game.id) is: ", parseInt(game.id));
  //     console.log("game.isWishlisted is: ", game.isWishlisted);
  //     console.log("coverImage is: ", coverImage);
  ...
  //     const gamespotRating = game.gamespotRating;
  //     const total = parseInt(currentPrice);
  //     const formattedTotal = total.toFixed(2);
  //     const product = {
  //       id: gameID,
  //       itemName: itemName,
  ...
  //     let cart = JSON.parse(localStorage.getItem("cart")) || [];
  //     const cartGame = cart.find((game) => parseInt(game.id) === gameID);
