...
setTimeout(() => {
  ...
  const html = games
    .map((game) => {
      ...
      const isGameInWishlist = localStorage.getItem(parseInt(game.id)) !== null;
      const heartIcon = parseInt(isGameInWishlist) ? "images/ico_heart_+.svg" : "images/ico_heart.svg";
      // const heartIcon = parseInt(isGameInWishlist) ? "images/ico_heart.svg" : "images/ico_heart_+.svg";
