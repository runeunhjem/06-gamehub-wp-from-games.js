...
setTimeout(() => {
  ...
  .map((game) => {
    ...
    const isGameInWishlist = wishlist.some((gameInList) => gameInList.id === game.id);
    console.log("isGameInWishlist is: ", isGameInWishlist);
    const heartIcon = isGameInWishlist ? "images/ico_heart.svg" : "images/ico_heart_+.svg";
